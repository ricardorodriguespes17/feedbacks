...
export function FeedbackContentStep({
  ...
  const { image, label } = feedbackTypes[feedbackType]
      ...
      <form className="my-4 w-full" onSubmit={handleSubmitFeedback}>
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            className="p-2 bg-brand-500 rounded-md border-transparent flex-1 flex justify-center text-sn hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500"
          >
